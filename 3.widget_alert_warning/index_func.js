...
for (let i = 0; i < demoData.length; i++) {
    ...
    device name: ${demoData[i].device_name}, address: ${demoData[i].address}, building: ${demoData[i].building}, floor: ${demoData[i].floor},  room: ${demoData[i].room}</div>`
        ...
        const setEl = `
         <div class='card2'>
             ...
             <div class="container-detail2"
                 ...
                 <div class="detail" style="color: #868383 margin-top: 10px margin-left: 10px;>
                     ${stringData}
                 </div>
             </div>
         </div>
